...
sections.forEach((section, idx) => {
    ...
    if (shouldHighlight) {
        ...
        section.contentSection.setAttribute('aria-hidden', 'false');
        section.titleLine.setAttribute('aria-expanded', 'true');
        ...
        section.contentSection.setAttribute('aria-hidden', 'true');
        section.titleLine.setAttribute('aria-expanded', 'false');
    } else {
