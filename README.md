...
The following actions require Jake's direct involvement:
...
Self-assessment via NCSC/IASME (~£300, 2-3 hrs). Removed from TrustBar until complete.

### 6. Client Testimonials

Canvas 3 past clients via `/feedback` link (Little Learners, Frisby's Aquatics).
