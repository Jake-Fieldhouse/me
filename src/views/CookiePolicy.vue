...
<template>
  <div class="min-h-screen pt-32 pb-20 px-6 max-w-4xl mx-auto text-white">
    ...
    <div class="space-y-8 text-neutral-300 leading-relaxed">
      <section>
        <h2 class="text-2xl font-bold text-white mb-4">1. What Are Cookies</h2>
        <p>Cookies are small text files stored on your device when you visit websites. They help websites function properly, remember your preferences, and provide usage analytics.</p>
      </section>

      <section>
        <h2 class="text-2xl font-bold text-white mb-4">2. Our Legal Basis</h2>
        <p>We use cookies in accordance with the Privacy and Electronic Communications Regulations 2003 (PECR) and UK GDPR. Some cookies are strictly necessary for the website to function; others require your consent.</p>
      </section>

      <section>
        <h2 class="text-2xl font-bold text-white mb-4">3. Cookies We Use</h2>
        <div class="overflow-x-auto">
          <table class="w-full text-sm border border-neutral-700 rounded-lg overflow-hidden">
            <thead class="bg-neutral-800">
              <tr>
                <th class="text-left p-3 font-semibold">Cookie Type</th>
            ...
            <tbody class="divide-y divide-neutral-700">
              <tr class="bg-neutral-900/50">
                <td class="p-3 font-medium text-white">Strictly Necessary</td>
                <td class="p-3">Essential for website functionality. Cannot be disabled.</td>
                <td class="p-3">Session</td>
              </tr>
              <tr class="bg-neutral-900/50">
                <td class="p-3 font-medium text-white">Preference Cookies</td>
                <td class="p-3">Remember your choices (e.g., cookie consent, theme).</td>
      ...
      <section>
        <h2 class="text-2xl font-bold text-white mb-4">5. Managing Cookies</h2>
      ...
      <section>
        <h2 class="text-2xl font-bold text-white mb-4">7. Changes to This Policy</h2>
        <p>We reserve the right to update this Cookie Policy at any time. Continued use of the website following any changes constitutes acceptance of the updated policy.</p>
      </section>
