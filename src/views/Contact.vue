...
<template>
  <div class="min-h-screen">
    <!-- Hero Section -->
    <header ref="heroRef" class="pt-28 pb-12 px-6 text-center">
      ...
      <p class="text-neutral-400 text-lg max-w-lg mx-auto">
        Pick your preferred way to reach out. I typically respond within a few hours.
      </p>
    </header>

    <!-- Main Content -->
    <main ref="contentRef" class="max-w-5xl mx-auto px-4 sm:px-6 pb-20 space-y-8">
      
      <!-- Contact Methods Grid - Clean, Uniform Cards -->
      <section class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        
        <!-- Call -->
        <a href="tel:+447404090458" 
           class="contact-method-card group">
          ...
          <div class="card-content">
            ...
            <span class="card-detail">07404 090458</span>
          </div>
        </a>

        <!-- WhatsApp -->
        <a href="https://wa.me/447404090458" target="_blank" rel="noopener"
           class="contact-method-card group">
          ...
          <div class="card-content">
            ...
            <span class="card-detail">Message me</span>
          </div>
        </a>
        ...
        <a href="mailto:jake@jakefieldhouse.co.uk" 
          ...
          <div class="card-icon bg-blue-500/15 group-hover:bg-blue-500/25">
            <svg class="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
              <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/>
            </svg>
          </div>
          <div class="card-content">
            <span class="card-label">Email</span>
            <span class="card-detail truncate">jake@jakefieldhouse.co.uk</span>
          </div>
        </a>

        <!-- LinkedIn -->
        <a href="https://uk.linkedin.com/in/jake-fieldhouse" target="_blank" rel="noopener"
           class="contact-method-card group">
          <div class="card-icon bg-[#0077b5]/15 group-hover:bg-[#0077b5]/25">
            <svg class="w-6 h-6 text-[#0077b5]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div class="card-content">
            ...
            <span class="card-detail">Connect</span>
          </div>
        </a>
      </section>
      ...
      <section class="grid lg:grid-cols-5 gap-6">
        ...
        <div class="lg:col-span-3 card-container">
          <div class="card-header">
            <h2 class="text-lg font-semibold text-white">Schedule a Call</h2>
            <span class="text-xs text-neutral-500">15 or 30 minutes • Free</span>
          </div>
          <div class="relative w-full" style="min-height: 520px;">
            ...
            <iframe 
              ...
              style="min-height: 520px; background: transparent;"
              loading="lazy"
              allow="payment"
        ...
        <div class="lg:col-span-2 card-container flex flex-col">
          <div class="card-header">
            ...
            <span class="text-xs text-neutral-500">I'll get back to you shortly</span>
          </div>
          <form @submit.prevent="submitForm" class="flex-1 flex flex-col p-5 gap-4">
            <div>
            ...
            <div class="flex-1 flex flex-col">
              <label class="block text-sm font-medium text-neutral-400 mb-1.5">Message</label>
              <textarea 
            ...
            <button 
              type="submit" 
              class="w-full py-3 px-4 bg-white text-black font-semibold rounded-xl hover:bg-neutral-200 transition-colors"
            >
              Send Message
            </button>
          </form>
      ...
      <!-- Secondary Links Row -->
      <section class="flex flex-wrap items-center justify-center gap-4 pt-4">
        <a href="https://signal.me/#p/+447404090458" target="_blank" rel="noopener"
        ...
        <a href="https://t.me/jakefieldhouse" target="_blank" rel="noopener"
           class="secondary-link">
        ...
        <a href="/contact.vcf" download="JakeFieldhouse.vcf" class="secondary-link">
      ...
      <div class="text-center pt-2">
        <router-link to="/" class="text-sm text-neutral-500 hover:text-white transition-colors">← Back to Home</router-link>
      </div>
    </main>
  </div>
</template>
