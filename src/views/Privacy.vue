  ...
  <div class="min-h-screen pt-32 pb-20 px-6 max-w-4xl mx-auto text-white">
    ...
    <div class="space-y-8 text-neutral-300 leading-relaxed">
      <section>
        ...
        <p>Jake Fieldhouse Consulting Ltd ("we", "us", "our") is committed to protecting your privacy. This policy explains how we collect, use, and safeguard your personal data in accordance with UK GDPR and the Data Protection Act 2018.</p>
      </section>

      <section>
        <h2 class="text-2xl font-bold text-white mb-4">2. Data We Collect</h2>
