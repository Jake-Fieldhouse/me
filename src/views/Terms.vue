  ...
  <div class="min-h-screen pt-32 pb-20 px-6 max-w-4xl mx-auto text-white">
    ...
    <div class="space-y-8 text-neutral-300 leading-relaxed">
      <section>
        ...
        <p>Jake Fieldhouse Consulting Ltd provides IT consulting, hardware repair, managed IT services, and e-waste collection. All services are subject to individual quotations and agreements.</p>
      </section>

      <section>
        <h2 class="text-2xl font-bold text-white mb-4">2. Quotations & Payment</h2>
        <p>All quotations are valid for 30 days unless otherwise stated. Payment terms are agreed per project. We reserve the right to withhold completed work until payment is received.</p>
      </section>

      <section>
        <h2 class="text-2xl font-bold text-white mb-4">3. Repair Services</h2>
        <ul class="list-disc list-inside space-y-2">
          <li>Diagnostic fees may apply and are communicated upfront</li>
          <li>We are not liable for pre-existing faults not disclosed prior to repair</li>
          <li>Warranty on repairs: 90 days for parts, 30 days for labour</li>
          <li>Data backup is the customer's responsibility</li>
        </ul>
      </section>
