...
<template>
  <div class="min-h-screen pt-32 pb-20 px-6 max-w-4xl mx-auto text-white">
    <h1 class="text-4xl font-bold mb-8">Cybersecurity Statement</h1>
    
    <div class="space-y-8 text-neutral-300 leading-relaxed">
      <div class="p-4 bg-cyan-500/10 border border-cyan-500/30 rounded-xl">
        <p class="text-cyan-400 font-medium">Security is fundamental to our IT services. We apply the same rigorous standards to our own operations that we recommend to our clients.</p>
      </div>
      ...
      <section>
        <h2 class="text-2xl font-bold text-white mb-4">2. Data Protection Measures</h2>
        <ul class="list-disc list-inside space-y-3">
          <li><strong class="text-white">Encryption in Transit:</strong> All data transmitted to and from our systems uses TLS 1.3 encryption</li>
      ...
      <section>
        <h2 class="text-2xl font-bold text-white mb-4">4. Website Security</h2>
        <p>This website is protected by:</p>
        <div class="mt-4 grid gap-3">
          <div class="p-3 bg-neutral-800 rounded-lg flex items-center gap-3">
            <span class="text-emerald-400 text-xl">🔒</span>
            <div>
              <p class="font-medium text-white">HTTPS Everywhere</p>
              <p class="text-sm text-neutral-400">HSTS preload with 2-year max-age</p>
            </div>
          </div>
          <div class="p-3 bg-neutral-800 rounded-lg flex items-center gap-3">
            <span class="text-emerald-400 text-xl">🛡️</span>
            <div>
              <p class="font-medium text-white">Content Security Policy</p>
              <p class="text-sm text-neutral-400">Strict CSP headers to prevent XSS attacks</p>
            </div>
          </div>
          <div class="p-3 bg-neutral-800 rounded-lg flex items-center gap-3">
            <span class="text-emerald-400 text-xl">🔐</span>
            <div>
              <p class="font-medium text-white">Security Headers</p>
              <p class="text-sm text-neutral-400">X-Frame-Options, X-Content-Type-Options, Referrer-Policy</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <ul class="list-disc list-inside space-y-2 mt-4">
          ...
          <li>Participation in cybersecurity communities and forums</li>
          <li>Regular review and update of security practices</li>
        </ul>
      </section>

      <section>
        <h2 class="text-2xl font-bold text-white mb-4">6. Incident Response</h2>
        <p>In the event of a security incident affecting client data:</p>
        <ul class="list-disc list-inside space-y-2 mt-4">
          <li>Immediate containment and investigation</li>
          <li>Notification to affected parties within 72 hours (per UK GDPR)</li>
          <li>ICO notification where legally required</li>
          <li>Full post-incident review and remediation</li>
        </ul>
      </section>

      <section>
        <h2 class="text-2xl font-bold text-white mb-4">7. Responsible Disclosure</h2>
        <p>If you discover a security vulnerability on our website or systems, please report it responsibly to <a href="mailto:jake@jakefieldhouse.co.uk" class="text-blue-400 hover:underline">jake@jakefieldhouse.co.uk</a> with the subject line "Security Vulnerability Report". We commit to:</p>
        <ul class="list-disc list-inside space-y-2 mt-4">
